...
enum opt_code
{
  ...
  /* OPT_fno_vect_cost_model = 741, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 742,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 743,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 744, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 745,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 746,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 747,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 748,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 749,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 750,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 751,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 752,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 753,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 754,             /* -fomit-frame-pointer */
  OPT_fopenmp = 755,                         /* -fopenmp */
  OPT_foperator_names = 756,                 /* -foperator-names */
  ...
  OPT_mdebug = 1054,                         /* -mdebug */
  OPT_mdebugd = 1055,                        /* -mdebugd */
  OPT_mdivide_breaks = 1056,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1057,                  /* -mdivide-traps */
  OPT_mdmx = 1058,                           /* -mdmx */
  OPT_mdouble_float = 1059,                  /* -mdouble-float */
  OPT_mdsp = 1060,                           /* -mdsp */
  OPT_mdspr2 = 1061,                         /* -mdspr2 */
  OPT_meb = 1062,                            /* -meb */
  OPT_mel = 1063,                            /* -mel */
  OPT_membedded_data = 1064,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1065,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1066,                  /* -mextern-sdata */
  OPT_mfix_24k = 1067,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1068,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1069,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1070,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1071,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1072,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1073,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1074,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1075,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1076,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1077,                 /* -mfp-exceptions */
  OPT_mfp32 = 1078,                          /* -mfp32 */
  OPT_mfp64 = 1079,                          /* -mfp64 */
  OPT_mfused_madd = 1080,                    /* -mfused-madd */
  OPT_mglibc = 1081,                         /* -mglibc */
  OPT_mgp32 = 1082,                          /* -mgp32 */
  OPT_mgp64 = 1083,                          /* -mgp64 */
  OPT_mgpopt = 1084,                         /* -mgpopt */
  OPT_mhard_float = 1085,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1086,              /* -minterlink-mips16 */
  OPT_mips = 1087,                           /* -mips */
  OPT_mips16 = 1088,                         /* -mips16 */
  OPT_mips3d = 1089,                         /* -mips3d */
  OPT_mllsc = 1090,                          /* -mllsc */
  OPT_mlocal_sdata = 1091,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1092,                    /* -mlong-calls */
  OPT_mlong32 = 1093,                        /* -mlong32 */
  OPT_mlong64 = 1094,                        /* -mlong64 */
  OPT_mmad = 1095,                           /* -mmad */
  OPT_mmcount_ra_address = 1096,             /* -mmcount-ra-address */
  OPT_mmcu = 1097,                           /* -mmcu */
  OPT_mmemcpy = 1098,                        /* -mmemcpy */
  OPT_mmt = 1099,                            /* -mmt */
  OPT_mmusl = 1100,                          /* -mmusl */
  OPT_mno_float = 1101,                      /* -mno-float */
  OPT_mno_flush_func = 1102,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1103,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1104,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1105,                     /* -mno-mips3d */
  OPT_mpaired_single = 1106,                 /* -mpaired-single */
  OPT_mplt = 1107,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1108,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1109,               /* -mrelax-pic-calls */
  OPT_mshared = 1110,                        /* -mshared */
  OPT_msingle_float = 1111,                  /* -msingle-float */
  OPT_msmartmips = 1112,                     /* -msmartmips */
  OPT_msoft_float = 1113,                    /* -msoft-float */
  OPT_msplit_addresses = 1114,               /* -msplit-addresses */
  OPT_msym32 = 1115,                         /* -msym32 */
  OPT_msynci = 1116,                         /* -msynci */
  OPT_mtune_ = 1117,                         /* -mtune= */
  OPT_muclibc = 1118,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1119,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1120,                  /* -mvr4130-align */
  OPT_mxgot = 1121,                          /* -mxgot */
  OPT_n = 1122,                              /* -n */
  OPT_no_canonical_prefixes = 1123,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1124,              /* -no-integrated-cpp */
  OPT_noasmopt = 1125,                       /* -noasmopt */
  OPT_nocpp = 1126,                          /* -nocpp */
  OPT_nodefaultlibs = 1127,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1128,                   /* -nostartfiles */
  OPT_nostdinc = 1129,                       /* -nostdinc */
  OPT_nostdinc__ = 1130,                     /* -nostdinc++ */
  OPT_nostdlib = 1131,                       /* -nostdlib */
  OPT_o = 1132,                              /* -o */
  OPT_p = 1133,                              /* -p */
  OPT_pass_exit_codes = 1134,                /* -pass-exit-codes */
  /* OPT_pedantic = 1135, */                 /* -pedantic */
  OPT_pedantic_errors = 1136,                /* -pedantic-errors */
  OPT_pg = 1137,                             /* -pg */
  OPT_pie = 1138,                            /* -pie */
  OPT_pipe = 1139,                           /* -pipe */
  OPT_posix = 1140,                          /* -posix */
  OPT_print_file_name_ = 1141,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1142,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1143,          /* -print-multi-directory */
  OPT_print_multi_lib = 1144,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1145,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1146,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1147,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1148,               /* -print-prog-name= */
  OPT_print_search_dirs = 1149,              /* -print-search-dirs */
  OPT_print_sysroot = 1150,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1151,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1152,                        /* -profile */
  ...
  OPT_time = 1209,                           /* -time */
  OPT_time_ = 1210,                          /* -time= */
  OPT_tno_android_cc = 1211,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1212,                 /* -tno-android-ld */
  OPT_traditional = 1213,                    /* -traditional */
  OPT_traditional_cpp = 1214,                /* -traditional-cpp */
  OPT_trigraphs = 1215,                      /* -trigraphs */
  OPT_u = 1216,                              /* -u */
  OPT_undef = 1217,                          /* -undef */
  OPT_v = 1218,                              /* -v */
  OPT_version = 1219,                        /* -version */
  OPT_w = 1220,                              /* -w */
  OPT_wrapper = 1221,                        /* -wrapper */
  OPT_x = 1222,                              /* -x */
  OPT_z = 1223,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
