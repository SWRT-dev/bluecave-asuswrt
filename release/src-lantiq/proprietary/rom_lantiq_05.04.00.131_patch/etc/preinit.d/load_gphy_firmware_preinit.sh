...
gphy_fw_load() {
	...
	if [ "$platform" = "GRX350" -o "$platform" = "GRX550" ]; then
		...
		switch_cli dev=0 GSW_MDIO_DATA_WRITE nAddressDev=2 nAddressReg=0 nData=0x1840
		...
		switch_cli dev=0 GSW_MDIO_DATA_WRITE nAddressDev=3 nAddressReg=0 nData=0x1840
		...
		switch_cli dev=0 GSW_MDIO_DATA_WRITE nAddressDev=4 nAddressReg=0 nData=0x1840
		...
		switch_cli dev=0 GSW_MDIO_DATA_WRITE nAddressDev=5 nAddressReg=0 nData=0x1840
		...
		switch_cli dev=1 GSW_MDIO_DATA_WRITE nAddressDev=1 nAddressReg=0 nData=0x1840
