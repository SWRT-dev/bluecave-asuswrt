...
Currently available applets include:
	...
	getopt, grep, gunzip, gzip, head, ifconfig, insmod, ionice, kill,
	killall, klogd, less, ln, logger, login, ls, lsmod, lspci, lsusb,
	md5sum, mdev, mkdir, mknod, mkswap, modprobe, more, mount, mv,
