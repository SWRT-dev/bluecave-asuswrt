 ...
 **************************************************************************
 *  \brief  Factory Reset wifi and reboot the board.
 *  \return 0 if success, negative if error / timeout
 ***************************************************************************/
int wlan_factoryComplete(void);

/**************************************************************************/
/*! \fn int wlan_clearWaveNvram(void)
 **************************************************************************
 *  \brief  Delete Wifi data from nvram
 *  \return 0 if success, negative if error / timeout
 ***************************************************************************/
...
/**************************************************************************/
/*! \fn wlan_getNumberOfRadios(int *radios)
**************************************************************************
*  \brief Return Number of Active Radios
*  \param[in] int *radios - variable to hold number of radios
*  \return 0 if success, negative if error / timeout
***************************************************************************/
int wlan_getNumberOfRadios(int *radios);

/**************************************************************************/
/*! \fn int wlan_setAccelerationMode(int index, bool *mode);
**************************************************************************
*  \brief set acceleration mode
*  \param[in] int index - radio index
*  \param[in] int *mode - true\false for acceleration
*  \return 0 if success, negative if error / timeout
***************************************************************************/
int wlan_setAccelerationMode(int index, bool mode);

/**************************************************************************/
/*! \fn int wlan_getAccelerationMode(int index, bool *mode);
**************************************************************************
*  \brief get acceleration mode
*  \param[in] int index - radio index
*  \param[in] int *mode - true\false for acceleration
*  \return 0 if success, negative if error / timeout
***************************************************************************/
