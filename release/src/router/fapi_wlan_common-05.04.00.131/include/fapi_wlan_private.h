...
// TODO: Automate getting the version string
#define FAPI_COMMON_VERSION "05.04.00_14_09"
...
#define BINS_PATH "/etc/wave/bins/"
...
#define BINS_PATH "/opt/lantiq/wave/bins/"
#define FAPI_RPC_MODE "/opt/lantiq/wave/fapi_rpc_mode"
#endif

#define DB_TEMP_PATH "/tmp/"                                                               /*!< \brief path to store t DB */
#define DB_TEMP_WAVE_PATH "/tmp/wlan_wave/"                                                /*!< \brief path to store t DB */
...
typedef struct {
	...
	int (*fapi_wlan_factory_reset)							(void);
	...
	int (*fapi_wlan_connection_status_get)					(const char *ifname, ObjList *wlObj, unsigned int flags);
	int (*fapi_wlan_metrics_get)							(const char *ifname, ObjList *wlObj, unsigned int flags);
