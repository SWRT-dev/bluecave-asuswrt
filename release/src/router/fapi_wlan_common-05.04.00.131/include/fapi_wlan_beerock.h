...
/**************************************************************************/
/*! \fn fapi_wlan_connection_status_get(const char *ifname, ObjList *wlObj, unsigned int flags)
**************************************************************************
*  \brief Get beacon report.
*  \param[in] ifname - interface name
*  \param[in,out] wlObj - Object list in empty object list (not NULL).
*  \param[in] flags - reserved
*  \return 0 if success, negative if error / timeout
***************************************************************************/
...
/**************************************************************************/
/*! \fn fapi_wlan_metrics_get(const char *ifname, ObjList *wlObj, unsigned int flags)
**************************************************************************
*  \brief Get beacon report.
*  \param[in] ifname - interface name
*  \param[in,out] wlObj - Object list in empty object list (not NULL).
